 ...
 */
const OPTIONS = [
  { n: 1, note: 'Jeweled crossbar, a black knight dangling at a tilt, lifted off its plinth. PINNED for now.' },
  ...
  return (
    <div className="h-full overflow-auto bg-[#0f1b2d] text-white">
      <div className="mx-auto max-w-5xl px-4 py-6">
        ...
        <p className="mt-1 text-sm text-white/70">Tell Claude the number you want. Option 1 is on the card right now.</p>
