...
const PLAIN: Partial<Record<AbilityId, string>> = {
  ...
  boulder: 'Drop a block of stone. Nothing gets past it.',
  shove: 'Push a block of stone one square away from you.',
  ...
  convert: 'Steal an enemy piece. It joins you next turn.',
};
