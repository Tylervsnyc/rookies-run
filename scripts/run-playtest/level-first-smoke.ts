...
const SCENARIOS: { name: string; loadouts: string[]; puzzle: RunPuzzle }[] = [
  ...
  {
    // THE ISLET: a ONE-square island, 1-thick ring — the square he crosses is
    // lava, so she pulls up short beside his landing square, on her own side.
    name: 'islet',
    loadouts: ['none', 'castle:4'],
    puzzle: {
      ...base,
      pieces: [E(5, 5, 'king')],
      hazards: [L(4, 4), L(4, 5), L(4, 6), L(5, 4), L(5, 6), L(6, 4), L(6, 5), L(6, 6)],
      kingPen: ['e5'],
    },
  },
  {
